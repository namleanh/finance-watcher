    ...
    <div className="rounded-2xl bg-white dark:bg-slate-900/60 border border-slate-200 dark:border-slate-700/50 overflow-hidden shadow-sm">
      ...
      <div className="p-4 border-b border-slate-200 dark:border-slate-700/50 space-y-3">
        <div className="flex items-center gap-3">
          <div className="relative flex-1">
            ...
            <input
              type="text"
              placeholder="Tìm giao dịch trong trang hiện tại..."
              value={search}
      ...
      {isLoading ? (
        ...
        <div className="overflow-x-auto">
          ...
          <div className="flex items-center justify-between px-4 py-3 border-t border-slate-700/30 bg-slate-50/50 dark:bg-slate-800/20">
            <div className="text-xs text-slate-500">
              Tổng {meta.total} giao dịch | Trang {page}/{meta.totalPages}
            </div>
            <div className="flex items-center gap-2">
              <button 
