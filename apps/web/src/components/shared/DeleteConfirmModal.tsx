        ...
        <div className="p-6">
          ...
          <div className="grid grid-cols-2 gap-3 mt-6">
            ...
            <button
              onClick={onConfirm}
              disabled={isLoading}
              className="px-4 py-3 rounded-xl bg-rose-600 text-white font-semibold text-sm hover:bg-rose-700 transition-all shadow-lg shadow-rose-600/20 active:scale-95 disabled:opacity-50"
            >
